        ...
        >
          ...
          <div className="w-full lg:w-1/2">
             <div className="relative rounded-[32px] overflow-hidden shadow-2xl group">
                ...
                <video 
                  src="https://res.cloudinary.com/dcjufshrh/video/upload/v1773653905/shutterstock_3940860195_psnpb5.mov" 
                  autoPlay
                  loop
                  muted
                  playsInline
                  className="w-full h-[400px] lg:h-[500px] object-cover transition-transform duration-700 group-hover:scale-105 relative z-0" 
                />
                
                {/* Floating Graphics Overlay */}
                <div className="absolute top-8 left-8 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-lg flex items-center gap-3 animate-pulse z-20">
